...
const BUDDY_CHIPS = [
  { color: "#FF9933", text: "Curious about sauna etiquette" },
  { color: "#0072CE", text: "Wants to understand Midsummer (Juhannus)" },
  { color: "#138808", text: "Loves cricket & hiking" },
  { color: "#4DA8DA", text: "Curious about Finnish work-life balance" },
];
